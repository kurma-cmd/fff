...
export const languageCourses: LanguageCourse[] = [
  { id: 'english', name: 'Английский', flag: 'EN', exam: 'IELTS / TOEFL', words: [['Hello', 'Привет'], ['Thank you', 'Спасибо'], ['University', 'Университет']] },
  { id: 'korean', name: 'Корейский', flag: 'KO', exam: 'TOPIK', words: [['안녕하세요', 'Привет'], ['감사합니다', 'Спасибо'], ['대학교', 'Университет']] },
  { id: 'german', name: 'Немецкий', flag: 'DE', exam: 'TestDaF / Goethe', words: [['Hallo', 'Привет'], ['Danke', 'Спасибо'], ['Universität', 'Университет']] },
  { id: 'french', name: 'Французский', flag: 'FR', exam: 'DELF / DALF', words: [['Bonjour', 'Привет'], ['Merci', 'Спасибо'], ['Université', 'Университет']] },
  { id: 'italian', name: 'Итальянский', flag: 'IT', exam: 'CILS / CELI', words: [['Ciao', 'Привет'], ['Grazie', 'Спасибо'], ['Università', 'Университет']] },
  { id: 'dutch', name: 'Нидерландский', flag: 'NL', exam: 'NT2', words: [['Hallo', 'Привет'], ['Bedankt', 'Спасибо'], ['Universiteit', 'Университет']] },
  { id: 'turkish', name: 'Турецкий', flag: 'TR', exam: 'TÖMER', words: [['Merhaba', 'Привет'], ['Teşekkürler', 'Спасибо'], ['Üniversite', 'Университет']] },
  { id: 'japanese', name: 'Японский', flag: 'JA', exam: 'JLPT', words: [['こんにちは', 'Привет'], ['ありがとう', 'Спасибо'], ['大学', 'Университет']] },
  { id: 'czech', name: 'Чешский', flag: 'CS', exam: 'Чешский B2', words: [['Ahoj', 'Привет'], ['Děkuji', 'Спасибо'], ['Univerzita', 'Университет']] },
  { id: 'chinese', name: 'Китайский', flag: 'ZH', exam: 'HSK', words: [['你好', 'Привет'], ['谢谢', 'Спасибо'], ['大学', 'Университет']] },
  { id: 'arabic', name: 'Арабский', flag: 'AR', exam: 'Внутренний тест', words: [['مرحبا', 'Привет'], ['شكرا', 'Спасибо'], ['جامعة', 'Университет']] },
  { id: 'thai', name: 'Тайский', flag: 'TH', exam: 'Внутренний тест', words: [['สวัสดี', 'Привет'], ['ขอบคุณ', 'Спасибо'], ['มหาวิทยาลัย', 'Университет']] },
  { id: 'indonesian', name: 'Индонезийский', flag: 'ID', exam: 'BIPA', words: [['Halo', 'Привет'], ['Terima kasih', 'Спасибо'], ['Universitas', 'Университет']] },
  { id: 'vietnamese', name: 'Вьетнамский', flag: 'VI', exam: 'Внутренний тест', words: [['Xin chào', 'Привет'], ['Cảm ơn', 'Спасибо'], ['Đại học', 'Университет']] },
  { id: 'kazakh', name: 'Казахский', flag: 'KK', exam: 'Зависит от программы', words: [['Сәлем', 'Привет'], ['Рақмет', 'Спасибо'], ['Университет', 'Университет']] },
  { id: 'russian', name: 'Русский', flag: 'RU', exam: 'Зависит от программы', words: [['Привет', 'Приветствие'], ['Спасибо', 'Благодарность'], ['Университет', 'Место учёбы']] },
  { id: 'malay', name: 'Малайский', flag: 'MS', exam: 'Внутренний тест', words: [['Hai', 'Привет'], ['Terima kasih', 'Спасибо'], ['Universiti', 'Университет']] },
  { id: 'hindi', name: 'Хинди', flag: 'HI', exam: 'Внутренний тест', words: [['नमस्ते', 'Привет'], ['धन्यवाद', 'Спасибо'], ['विश्वविद्यालय', 'Университет']] },
];
